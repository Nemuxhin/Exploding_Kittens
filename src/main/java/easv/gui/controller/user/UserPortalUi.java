...
final class UserPortalUi {
    ...
    private static String iconPath(String key) {
        return switch (key) {
            ...
            case "file" -> "M6 2h8l4 4v12H6V2zm2 2v12h8V7h-3V4H8zm2 4h4v2h-4V8zm0 4h6v2h-6v-2z";
            ...
            case "selected-check" -> "M8.2 13.2L5 10l1.4-1.4 1.8 1.8 5.4-5.4L15 6.4l-6.8 6.8z";
